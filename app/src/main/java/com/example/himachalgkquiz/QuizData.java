...
import com.example.himachalgkquiz.Modal;
...
public class QuizData {
 ...
 ArrayList<Modal> QuizData()
 {
    ...
    String question9[]={"Chur Dhar","Pir Panjal","Shilla","Shri Khand Mahadev"};
    ...
    String question15[]={"1 July 1956","1 July 1954","1 July 1955","1 July 1950"};
     ...
     quizData.add(new Modal("Which is the highest peak in Himachal Pradesh ?",question9,"Shilla",false));
